...
Zak³adki umo¿liwiaj± wybór \textit{Pioneera}, którego pozycjê chcemy zmieniæ. Aktywne s± tylko zak³adki skojarzone z~robotami dodanymi aktualnie do ¶wiata. 
...
Przyci¶niêcie przycisku \texttt{Ustaw} powoduje ustawienie \textit{Pioneera} zgodnie z~¿±daniem. Przycisk \texttt{Reset} przenosi robota do punktu $(0, 0)$ i~ustawia jego orientacjê na~$0$. 
...
Wy¶wietlanie pozycji i~orientacji robota mo¿liwe jest dziêki subskrybowaniu odpowiedniego tematu i~wywo³aniu funkcji aktualizuj±cej pozycjê robota:
\begin{lstlisting}[language=C++, numbers=none]
