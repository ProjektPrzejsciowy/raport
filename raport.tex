...
\hypersetup{
    ...
    urlcolor=blue,   % kolor odno¶ników do adresów internetowych, domy¶lnie cyan
                               % DANE DOKUMENTACJI
    pdfauthor={ARR2016},
    pdftitle={Projekt przejściowy --- Symulator laboratorium L1.5},
 }
                                   % DEFINICJE W£ASNE
\newcommand{\dd}{\text{d}}
...
\include{wstep/wstep}
\include{wykorzystane_narzedzia/wykorzystane_narzedzia}
\include{opis_systemu/opis_systemu}
\include{testy/testy}
\include{wnioski/wnioski}
\appendix
\include{dodatki/instrukcja_dla_uzytkownika}
\include{dodatki/instrukcja_dla_dewelopera}
