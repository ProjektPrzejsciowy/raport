...
Wêze³ tworzony przez Gazebo publikuje informacje na zewn±trz za pomoc± tematów, np. \verb!~/model_states!, wysy³aj±cy informacje o stanie modeli aktualnie u¿ywanych w symulacji. Wêze³ dostarcza równie¿ us³ugi ROSa, takie jak \verb!~/spawn_urdf_model! do ³adowania modeli robotów w formacie URDF, czy \verb!~/delete_model! do usuwania modeli. Mog± zostaæ one wykorzystane przez u¿ytkownika naszego systemu do kontroli symulacji i zbierania danych symulacyjnych.