...
W miejsce $[$scie¿ka do katalogu lokalnego$]$ nale¿y podaæ ¶cie¿kê do katalogu z pobranym kodem ¼ród³owym pluginu. W przypadku korzystania z przygotowanego obrazu w wersji deweloperskiej  w miejsce [nazwa obrazu] nale¿y podstawiæ:
\begin{verbatim}
